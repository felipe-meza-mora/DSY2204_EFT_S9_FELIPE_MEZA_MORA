...
fun SplashScreen(){
    ...
    val isUserLoggedIn = sharedPreferences.getString("userEmail", null)
    ...
    LaunchedEffect(key1 = true) {
        ...
        delay(2000L)
        val intent = if (isUserLoggedIn != null) {
            Intent(context, MenuActivity::class.java) // Redirige al menú si está logueado
        } else {
            Intent(context, LoginActivity::class.java) // Redirige al login si no está logueado
        }
